...
export const FIELD_CATEGORY = 'accommodation_category' //TODO: Check TRIP-17
...
export const itemSpecificFieldsNoLocale = {
  ...
  [ACCOMMODATION_ITEM_TYPE]: [FIELD_ADDRESS, FIELD_GEOLOCATION, FIELD_SUPPLIER_TAG, FIELD_CATEGORY]
}
